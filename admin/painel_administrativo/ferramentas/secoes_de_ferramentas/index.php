			...
			for (const i in data) {
				sectionsHTML +=
					`<tr>
						...
						<td>
							<a class="btn waves-effect waves-light green darken-3 z-depth-0" title="Editar informações de ${data[i][0]}" href="atualizar_dados/?section_id=${i}"><i class="material-icons">edit</i></a>
