...
<body class="grey lighten-4">
	...
	<div id="removeAdmin" class="modal">
		...
		<div class="modal-footer">
			...
			<a id="linkRemoveAdmin" title="Remover Administrador" class="modal-close waves-effect waves-light btn-flat indigo darken-4 white-text"><i class="material-icons left green-text" style="font-size:27px">check</i>Sim</a>
		</div>
	</div>
