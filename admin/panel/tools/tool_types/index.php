			...
			<div class="card-panel z-depth-2 top-div-margin" style="padding-bottom:10px">
				...
				<form id="formInsert" style="margin-top:15px" method="POST">
					<div class="row mb-0">
						...
						<div class="col s12">
							<div class="divider"></div>
							<button title="Inserir Tipo de Ferramentas no 4People" class="btn waves-effect waves-light btn-green mt-2 z-depth-0"><i class="material-icons left">folder</i>Inserir</button>
						</div>
					</div>
				</form>
