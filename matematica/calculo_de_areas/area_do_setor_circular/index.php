...
<head>
	...
	<meta name="msapplication-starturl" content="./matematica/calculo_de_areas/area_do_setor_circular/">
	...
	<meta property="og:url" content="./matematica/calculo_de_areas/area_do_setor_circular/">
	<meta name="twitter:url" content="./matematica/calculo_de_areas/area_do_setor_circular/">
</head>
	...
	<main>
		<div class="container">
			<div class="card-panel left-div-margin">
				<h1 class="flow-text" style="margin:0 0 5px"><i class="material-icons left">compare</i>Área do Setor Circular</h1>

				<label>Calculador de Área do Setor Circular Online. π = PI, Área do Setor Circular = π * (Raio² * Ângulo) / 360</label>
