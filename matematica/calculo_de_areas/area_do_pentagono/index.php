...
<head>
	...
	<title>Área do Pentágono - 4People</title>
	<?php include_once("$assets/components/meta_tags.php") ?>
	<meta name="keywords" content="4people,4devs,pessoas,online,ferramentas,desenvolvedores,computacao,matematica,geradores,validadores,faker">
	<meta name="title" content="Área do Pentágono - 4People">
	<meta name="description" content="Calcular área do Pentágono. 4People é um site feito para ajudar estudantes, professores, programadores e pessoas em suas atividades diárias.">
	<meta name="application-name" content="4People">
	<meta name="msapplication-starturl" content="./matematica/calculo_de_areas/area_do_pentagono/">
	<meta property="og:title" content="Área do Pentágono - 4People">
	<meta name="twitter:title" content="Área do Pentágono - 4People">
	<meta property="og:url" content="./matematica/calculo_de_areas/area_do_pentagono/">
	<meta name="twitter:url" content="./matematica/calculo_de_areas/area_do_pentagono/">
</head>
...
<body class="grey lighten-3">
	...
	<main>
		<div class="container">
			<div class="card-panel left-div-margin">
				<h1 class="flow-text" style="margin:0 0 5px"><i class="material-icons left">compare</i>Área do Pentágono</h1>

				<label>Calculador de Área do Pentágono Online. Área do Pentágono = (5 * Lado²) / (4 * tan(36°))</label>
	...
	<script src="<?= $assets ?>/algorithms/areas_calculator/pentagonArea.js"></script>
