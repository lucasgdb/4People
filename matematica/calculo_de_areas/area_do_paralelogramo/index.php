...
<head>
	...
	<title>Área do Paralelogramo - 4People</title>
	<?php include_once("$assets/components/meta_tags.php") ?>
	<meta name="keywords" content="4people,4devs,pessoas,online,ferramentas,desenvolvedores,computacao,matematica,geradores,validadores,faker">
	<meta name="title" content="Área do Paralelogramo - 4People">
	<meta name="description" content="Calcular área do Paralelogramo. 4People é um site feito para ajudar estudantes, professores, programadores e pessoas em suas atividades diárias.">
	<meta name="application-name" content="4People">
	<meta name="msapplication-starturl" content="./matematica/calculo_de_areas/area_do_paralelogramo/">
	<meta property="og:title" content="Área do Paralelogramo - 4People">
	<meta name="twitter:title" content="Área do Paralelogramo - 4People">
	<meta property="og:url" content="./matematica/calculo_de_areas/area_do_paralelogramo/">
	<meta name="twitter:url" content="./matematica/calculo_de_areas/area_do_paralelogramo/">
</head>
...
<body class="grey lighten-3">
	...
	<main>
		<div class="container">
			<div class="card-panel left-div-margin">
				<h1 class="flow-text" style="margin:0 0 5px"><i class="material-icons left">compare</i>Área do Paralelogramo</h1>

				<label>Calculador de Área do Paralelogramo Online. Área do Paralelogramo = Base * Altura</label>
	...
	<script src="<?= $assets ?>/algorithms/areas_calculator/parallelogramArea.js"></script>
