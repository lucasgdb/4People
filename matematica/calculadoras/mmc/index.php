...
<body>
    ...
    <main class="grey lighten-5 hide">
        <div class="container">
            <div class="card-panel">
                ...
                <button title="Encontrar o Mínimo Múltiplo Comum" class="btn waves-effect waves-dark white black-text btn-center" onclick="calculate()">
                    Encontrar MMC
                </button>
    ...
    <script src="<?= $return ?>/algoritmos/LCM.js"></script>
