    ...
    '<footer class="hide">
            ...
            <div class="row">
                <div class="col l6 s12">
                    ...
                    <p class="grey-text text-darken-4">
                        ...
                        Feito com <img class="img" src="/imagens/heart.png" alt="Coração"> e <img style="position:relative;top:2.5px" src="/imagens/js.png" alt="JavaScript">.
        ...
        <div class="footer-copyright">
            <div class="container grey-text text-darken-4">
                © 4People - 2019
                <a class="right indigo-text text-accent-4" href="https://github.com/LucasNaja/4People"><i class="material-icons left" style="position:relative;top:-1.5px">code</i>Código fonte (MIT)</a>
            </div>
        </div>
    </footer>';
