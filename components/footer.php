    ...
    echo "<footer class=\"hide\">
        ...
        <div class=\"footer-copyright\">
            <div class=\"container grey-text text-darken-4\">
                © 4People - 2019
                <a class=\"right indigo-text text-accent-4\" href=\"https://github.com/LucasNaja/4People\"><i class=\"material-icons left\">code</i>Código fonte (MIT)</a>
            </div>
        </div>
    </footer>";
