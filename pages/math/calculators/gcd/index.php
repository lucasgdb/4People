	...
	<main>
		<div class="container">
			<div class="card-panel top-div-margin">
				...
				<button title="Encontrar o Máximo Divisor Comum" class="btn btn-center waves-effect waves-light btn-green z-depth-2" onclick="calculate()">
					Encontrar MDC
				</button>
				<div class="divider mt-2"></div>

				<textarea class="mt-2" id="result" placeholder="Resultado" spellcheck="false" readonly></textarea>
				<button title="Copiar MDC" class="btn waves-effect waves-light dark-grey mt-1 z-depth-0" onclick="copyResult()">
					Copiar
				</button>
				<button title="Limpar MDC" class="btn waves-effect waves-light dark-grey mt-1 z-depth-0" onclick="clearInput()">
					Limpar
				</button>
