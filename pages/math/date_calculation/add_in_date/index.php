...
<head>
	...
	<title>Somar em Data - 4People</title>
	<?php include_once("$assets/components/MetaTags.php") ?>
	<meta name="keywords" content="4people,4devs,pessoas,online,ferramentas,desenvolvedores,computacao,matematica,geradores,validadores,faker">
	<meta name="title" content="Somar em Data - 4People">
	<meta name="description" content="Ferramenta para somar dias, semanas, meses ou anos em uma data. 4People é um site feito para ajudar estudantes, professores, programadores e pessoas em suas atividades diárias.">
	<meta name="application-name" content="4People">
	<meta property="og:title" content="Somar em Data - 4People">
	<meta name="twitter:title" content="Somar em Data - 4People">
</head>
...
<body>
	...
	<main>
		<div class="container">
			<div class="card-panel top-div-margin">
				...
				<button title="Somar na Data" class="btn btn-center waves-effect waves-light red-color z-depth-0" onclick="calculate()">
					Adicionar
				</button>
	...
	<script src="<?= $assets ?>/algorithms/dates_calculator/addInDate.js"></script>
