...
<head>
	...
	<title>Validador de RG - 4People</title>
	<?php include_once("$assets/components/MetaTags.php") ?>
	<meta name="keywords" content="4people,4devs,pessoas,online,ferramentas,desenvolvedores,computacao,matematica,geradores,validadores,faker">
	<meta name="title" content="Validador de RG - 4People">
	<meta name="description" content="Validador de RG Online para validar RGs. 4People é um site feito para ajudar estudantes, professores, programadores e pessoas em suas atividades diárias.">
	<meta name="application-name" content="4People">
	<meta property="og:title" content="Validador de RG - 4People">
	<meta name="twitter:title" content="Validador de RG - 4People">
</head>
...
<body>
	...
	<main>
		<div class="container">
			<div class="card-panel top-div-margin">
				...
				<div class="row mb-0">
					<p class="mb-0 col s12">Digite o RG:</p>

					<div class="input-field col s12">
						<input id="rg" placeholder="Ex: 48.652.842-X ou 48652842X" type="text" maxlength="14">
					</div>
				</div>

				<div class="divider mb-2"></div>
				<button title="Validar RG" class="btn btn-center waves-effect waves-light red-color z-depth-2" onclick="validate()">
					Validar RG
				</button>
	...
	<script src="<?= $assets ?>/algorithms/validators/RGValidator.js"></script>
