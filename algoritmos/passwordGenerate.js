function generatePassword(
    ...
    } else if (firstChar === 'upperCase') {
        password += upperCases[parseInt(Math.random() * upperCases.length)]
    } else if (firstChar === 'lowerCase') {
        password += lowerCases[parseInt(Math.random() * lowerCases.length)]
    } else {
        password += specials[parseInt(Math.random() * specials.length)]
    }
