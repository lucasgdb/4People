            ...
            <div class="card-panel">
                ...
                <div class="row mt-2">
                    <div class="col s12 m8 offset-m2">
                        <div class="col s3">
                            <img title="Lucas Bittencourt" class="responsive-img circle" src="../assets/imagens/lucas.jpg" alt="Lucas Bittencourt">
                        </div>

                        <div class="col s3">
                            <img title="Jairo Arcy" class="responsive-img circle" src="../assets/imagens/jairo.jpg" alt="Jairo Arcy">
                        </div>

                        <div class="col s3">
                            <img title="Renan de Mattos" class="responsive-img circle" src="../assets/imagens/renan.jpg" alt="Renan de Mattos">
                        </div>

                        <div class="col s3">
                            <img title="Suzany Silva" class="responsive-img circle" src="../assets/imagens/suzany.jpg" alt="Suzany Silva">
                        </div>
                    </div>
