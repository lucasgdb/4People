	...
	<main>
		<div class="container">
			<div class="card-panel top-div-margin">
				<h1 class="mont-serrat dark-grey-text" style="font-size:30px;margin:-5px 0 10px"><i class="material-icons left" style="top:5px"><?= $icon ?></i>Principais Ferramentas</h1>

				<label class="dark-grey-text">Principais Ferramentas de <?= $name ?> do 4People.</label>
