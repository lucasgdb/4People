...
<body>
    ...
    <main class="grey lighten-5">
        <div class="container">
            <div class="card-panel">
                <h1 class="flow-text mt-2">Código de Eventos das Teclas</h1>
                ...
                <div class="row mb-0">
                    <h4 class="mt-0 col s12">Pressione qualquer tecla.</h4>
    ...
    <script src="<?= "$return/algorithms/jsEventKeyCodes.js" ?>"></script>
