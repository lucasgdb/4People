	...
	<main>
		<div class="container">
			<div class="card-panel left-div-margin">
				...
				<button title="Copiar Meta Tags" class="btn waves-effect waves-light indigo darken-4" onclick="copyResult()">
					Copiar
				</button>
				<button title="Limpar Meta Tags" class="btn waves-effect waves-light indigo darken-4" onclick="clearInput()">
					Limpar
				</button>
