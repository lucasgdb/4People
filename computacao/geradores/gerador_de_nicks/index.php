...
<body class="grey lighten-3">
	...
	<main>
		<div class="container">
			<div class="card-panel">
				<h1 class="flow-text" style="margin:0 0 5px"><i class="material-icons left">computer</i>Gerador de Nicks</h1>
	...
	<script src="<?= "$assets/algorithms/nickGenerator.js" ?>"></script>
