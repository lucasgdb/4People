 ...
 const txtPasswordName = document.querySelector('#namePassword')
 ...
 const savePassword = () => {
     if (txtResult.value.trim() !== '') {
         saveAs(new File([`Senha: ${txtResult.value}`], `${txtPasswordName.value}.txt`, { type: "text/plain;charset=utf-8" }))
     } else {
         M.toast({
