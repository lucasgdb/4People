        ...
        <nav class="grey lighten-3">
            ...
            <div class="nav-wrapper">
                ...
                <ul id="nav-mobile" class="left hide-on-med-and-down">
                    ...
                    <li title="Outras Ferramentas" class="active waves-effect"><a class="grey-text text-darken-4" href="/outras_ferramentas/"><i class="material-icons left">build</i>Outras Ferramentas</a></li>
                </ul>
            </div>
        </nav>
